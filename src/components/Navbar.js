    ...
    return (
        <nav className="navbar">
            <div className="container">
                ...
                {
                   props.isRequired && <div className="rikesh-nav__actions">
                        <div className="dropdown">
                            <button className="btn rikesh-nav__notification-wrapper dropdown-toogle" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false" aria-label="notfication">
                        ...
                        <img className="rikesh-nav__img" width={32} height={32} src={props.imgUrl} alt="nav data"></img>
                        <div className="rikesh-nav__welcome-text">Welcome!! {props.name}</div>
                        <button className="dashboard__btn btn btn-primary" onClick={logout}>
                        Logout
                        </button>
                        <div className="dropdown">
                            <button className="btn rikesh-nav__settings dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" aria-label="settings">
